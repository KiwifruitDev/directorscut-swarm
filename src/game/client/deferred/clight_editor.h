...
#define SELECTION_PICKER_SIZE 4.0f
...
public:
	...
	enum EDITORINTERACTION_MODE
	{
		...
		EDITORINTERACTION_UNIVERSAL,
		
		EDITORINTERACTION_COUNT,

		EDITORINTERACTION_FIRST_TOOL = EDITORINTERACTION_SELECT,
		EDITORINTERACTION_FIRST_GIZMO = EDITORINTERACTION_TRANSLATE,
	};
	...
	enum EDITOR_SELECTEDAXIS
	{
		...
		EDITORAXIS_FIRST_ROTATION = EDITORAXIS_PITCH,
